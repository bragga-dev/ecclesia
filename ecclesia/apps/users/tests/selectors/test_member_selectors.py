...
from ecclesia.apps.users.models import User, Member, MemberAddress, Church, ROLE_MEMBER, ROLE_CHURCH
from ecclesia.apps.community.models import MemberChurch
