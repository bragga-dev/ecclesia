...
from ecclesia.apps.users.models import User, ROLE_ADMIN, ROLE_MEMBER, ROLE_CHURCH
from ecclesia.apps.users.selectors.user import (
    get_user_by_id,
    get_user_by_email,
    get_user_by_slug,
    email_exists,
...
class TestUserSelectorsWithChurchAndMember(TestCase):
    ...
    def setUp(self):
        ...
        from ecclesia.apps.users.models import Member
