...
from ecclesia.apps.users.models.constants import ROLE_ADMIN, ROLE_MEMBER, ROLE_CHURCH
from ecclesia.apps.users.models.user_manage import UserManager

# ─────────────────────────────────────────────────────────────────────────────
# Upload path
# Gera: photos/<uuid>/photo.jpg  no bucket ecclesia-media.
# ─────────────────────────────────────────────────────────────────────────────
...
#   mc cp default/user_img.jpg local/ecclesia-media/default/user_img.jpg
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # default aponta para arquivo que deve existir no bucket ecclesia-media.
