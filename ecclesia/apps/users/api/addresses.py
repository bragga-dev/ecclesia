...
from ecclesia.apps.users.permissions import require_verified, VerifiedUserAuth
...
def delete_address(request, address_id: uuid.UUID):
    ...
    from ecclesia.apps.users.selectors.church_selector import get_address_by_id_and_church
    from ecclesia.apps.users.selectors.member_selector import get_address_by_id_and_member
    from ecclesia.apps.users.selectors.church_selector import get_church_by_user_id
    from ecclesia.apps.users.selectors.member_selector import get_member_by_user_id
