...
LOCAL_APPS = [
    "ecclesia.apps.users",
    "ecclesia.apps.community",
    # "ecclesia.apps.members",
    # "ecclesia.apps.contributions",
    # "ecclesia.apps.payments",
    # "ecclesia.apps.receipts",
    # "ecclesia.apps.reports",
    # "ecclesia.apps.dashboards",
    # "ecclesia.apps.webhooks",
]
...
ROOT_URLCONF = "ecclesia.config.urls"
...
WSGI_APPLICATION = "ecclesia.config.wsgi.application"

ASGI_APPLICATION = "ecclesia.config.asgi.application"
...
STORAGES = {
    "default": {
        "BACKEND": "ecclesia.config.storages.MediaFilesStorage",
    },
    "staticfiles": {
