...
from ecclesia.apps.users.api.auth import router as auth_router
from ecclesia.apps.users.api import router as users_router
from ecclesia.apps.community.api import router as community_router
from ecclesia.apps.users.api.admin import router as admin_router
