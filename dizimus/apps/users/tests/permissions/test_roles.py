...
class TestChurchMembershipChecks:
    ...
    @patch('dizimus.apps.users.permissions.roles.has_role_in_church')
...
class TestCombinators:
    ...
    @patch('dizimus.apps.users.permissions.roles.is_admin')
    @patch('dizimus.apps.users.permissions.roles.is_church_owner')
    @patch('dizimus.apps.users.permissions.roles.is_church_admin')
    @patch('dizimus.apps.users.permissions.roles.is_pastor')
    @patch('dizimus.apps.users.permissions.roles.is_treasurer')
    @patch('dizimus.apps.users.permissions.roles.is_secretary')
