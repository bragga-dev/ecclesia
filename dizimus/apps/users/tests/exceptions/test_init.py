...
class TestExports:
    ...
    def test_all_imports_available(self):
        ...
        from dizimus.apps.users.exceptions import __all__
    ...
    def test_import_from_package(self):
        ...
        from dizimus.apps.users import exceptions 
    ...
    def test_classes_are_same(self):
        ...
        from dizimus.apps.users.exceptions.auth import InvalidCredentials as AuthInvalidCredentials
        from dizimus.apps.users.exceptions.user import UserAlreadyExists as UserUserAlreadyExists
        from dizimus.apps.users.exceptions.permissions import PermissionDenied as PermissionsPermissionDenied
